...
namespace PruebaTekus.Tests.ServicesTest
{
    public class ServicesServiceTests
    {
        ...
        public async Task UpdateServiceAsync_ReturnsUpdatedServiceDto()
        {
            ...
            var service = new Services { idservice = 1, service = "Service 1", ProvidersServices = new List<ProvidersServices>() };
        ...
        public async Task GetServiceCountByCountryAsync_ReturnsDictionary()
        {
            ...
            var services = new List<Services>
            {
                new Services
                {
                    idservice = 1,
                    service = "Redes",
                    ProvidersServices = new List<ProvidersServices>
                    {
                        new ProvidersServices { Country = new Country { country = "Colombia" } },
                        new ProvidersServices { Country = new Country { country = "Argentina" } }
                    }
                },
                new Services
                {
