...
namespace PruebaTekus.Tests.RepositoryTest
{
    public class CountryRepositoryTests
    {
        ...
        public CountryRepositoryTests()
        {
            _options = new DbContextOptionsBuilder<DataContext>()
                .UseInMemoryDatabase(databaseName: "TestDatabasePruebaTekus")
                .Options;
        ...
        private void SeedDatabase()
        {
            ...
            var country1 = new Country { idcountry = 1, country = "Colombia", ProvidersServices = new List<ProvidersServices>() };
            var country2 = new Country { idcountry = 2, country = "Argentina", ProvidersServices = new List<ProvidersServices>() };

            _context.Countries.AddRange(country1, country2);

            var providerHasService1 = new ProvidersServices { Providers_idprovider = 1, Services_idservice = 1, Country_idcountry = 1, Provider = provider1, Country = country1, Services = service1 };
            var providerHasService2 = new ProvidersServices { Providers_idprovider = 2, Services_idservice = 2, Country_idcountry = 2, Provider = provider2, Country = country2, Services = service2 };

            _context.Providers_Services.AddRange(providerHasService1, providerHasService2);
        ...
        public async Task GetByIdAsync_ReturnsCountry_WhenCountryExists()
        {
            ...
            Assert.NotNull(result.ProvidersServices);
            Assert.Single(result.ProvidersServices);
        }
