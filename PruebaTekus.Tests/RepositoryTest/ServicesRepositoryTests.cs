...
namespace PruebaTekus.Tests.RepositoryTest
{
    public class ServicesRepositoryTests
    {
        ...
        private void SeedDatabase()
        {
            ...
            var providerHasService1 = new ProvidersServices { Providers_idprovider = 1, Services_idservice = 1, Country_idcountry = 1, Provider = provider1, Country = country1 };
            var providerHasService2 = new ProvidersServices { Providers_idprovider = 2, Services_idservice = 2, Country_idcountry = 2, Provider = provider2, Country = country2 };
