...
namespace PruebaTekus.Tests.RepositoryTest
{
    public class ProviderRepositoryTests
    {
        ...
        private void SeedDatabase()
        {
            ...
            var providerHasService1 = new ProvidersServices { Providers_idprovider = 1, Services_idservice = 1, Country_idcountry = 1, Country = country1 };
            var providerHasService2 = new ProvidersServices { Providers_idprovider = 2, Services_idservice = 2, Country_idcountry = 2, Country = country2 };
            var providerHasService3 = new ProvidersServices { Providers_idprovider = 1, Services_idservice = 3, Country_idcountry = 1, Country = country1 };

            _context.Providers_Services.AddRange(providerHasService1, providerHasService2, providerHasService3);
