    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<Provider, ProviderDto>()
                ...
                .ForMember(dest => dest.Countries, opt => opt.MapFrom(src => src.ProvidersServices != null ? src.ProvidersServices.Select(phs => new ProviderCountryDto
                {
            ...
            CreateMap<Domain.Entities.Services, ServiceDto>()
                ...
                .ForMember(dest => dest.Providers, opt => opt.MapFrom(src => src.ProvidersServices != null ? src.ProvidersServices
